...
- **Immersive Audio**: AI-generated voice-overs and music
...
- **AI-Generated Voice-Over**: **ElevenLabs Flash v2.5** model delivers ultra-low latency narration for real-time storytelling
- **AI-Generated Music**: Background music generated by ElevenLabs Music Studio for immersive ambiance
...
- **ElevenLabs Flash v2.5**: We use the `eleven_flash_v2_5` model for voice generation. This specific model is chosen for its **ultra-low latency** (<100ms) and cost-effectiveness, making it ideal for real-time interactive games where immediate feedback is crucial.
- **Streaming Audio**: Voice data is streamed directly from the backend to the frontend to minimize wait times.
- **Audio Ducking**: Background music volume automatically adjusts during narration for better clarity.
...
- **ElevenLabs API**: Text-to-Speech and Sound Effects
...
2. **Listen & Read**: The game narrates the story while you read along
...
- `POST /api/game/generate-voice` - Stream voice-over audio
...
- Ensure you have sufficient quota on ElevenLabs
...
- Voice-overs by ElevenLabs (Flash v2.5 model)
- Background music generated with ElevenLabs Music Studio
